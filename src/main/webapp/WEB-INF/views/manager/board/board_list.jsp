		...
		<div class="sh_board_list_content">
			...
			<div class="sh_board_list_list">
				...
				<ul>
					...
					<li>로그인/아이디</li>
					<li>17/12/20</li>
					<li><button type="button" class="bf-button bf-white-btn">수정</button>
						<button type="button" class="bf-button bf-white-btn">삭제</button></li>
				</ul>
				<ul>
					<li><label class="bf-custom-checkbox"> <input type="checkbox" title="목록" class="sh_check" /> <span class="all-mark"></span><span class="checkbox-label"></span></label></li>
					<li>2</li>
				...
				<ul>
					...
					<li>오류</li>
					<li>15/12/21</li>
					<li><button type="button" class="bf-button bf-white-btn sh_list_update">수정</button>
						<button type="button" class="bf-button bf-white-btn sh_list_delete">삭제</button></li>
				</ul>
