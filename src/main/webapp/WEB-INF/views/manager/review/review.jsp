		...
		<div class="sh_review_header">
			...
			<div class="sh_review_main">
				...
				<div class="sh_review_search">
					...
					<ul>
						<li>적립금</li>
						<li><input name="point" type="radio" checked="checked">예정</li>
		...
		<div class="sh_review_content">
			...
			<div class="sh_review_list">
				...
				<ul>
					...
					<!-- 회원정보로 넘어가기-->
					<li>2</li>
					<li><button type="button" type="button" class="bf-button bf-white-btn">비공개</button>
						<button type="button" type="button" class="bf-button bf-white-btn">삭제</button></li>
...
2018.01.05   신고
잘 읽히는 편이기는하지만 일부러 자극적이게 표현하려는게 고루하다는 생각이 들었습니다. 약한 반전 이외에는 예상했던 대로 흘러가서 나중에는 흥미를 잃었습니다.</p>
				</div>
