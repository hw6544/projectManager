		...
		<div class="sh_member_detail_header">
			...
			<div class="sh_member_detail_main">
				<div class="sh_member_detail_inf">
					<ul>
						<li><p>전상헌</p>
							<span>(jeonsh1220) 님</span></li>
						<li><p>북팩 충전금</p>
							<span>70000 원</span></li>
						<li><p>적립금</p>
							<span>10000 point</span></li>
						<li><p>쿠폰</p>
							<span>3 장</span></li>
					</ul>
				</div>
				<div class="sh_member_detail_inf2">
					<span>적립금부여</span>
					<input type="text"><button type="button" style="height: 2.2rem;" class="bf-button bf-white-btn sh_point">적립</button>
				</div>
			</div>
